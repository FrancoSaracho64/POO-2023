...
import unlu.poo.trabajoPractico_1.tads.listas.listaDoble.Lista;
...
public class Ejercicio_2 {
    ...
    public static void mostrar_lista(Lista lista){
        ...
        for (int i = 1; i <= elementos; i++){
            ...
            System.out.println("ANTERIOR--> " + lista.recuperar(i).getAnterior());
            System.out.println("SIGUIENTE--> " + lista.recuperar(i).getSiguiente());
            System.out.println();
        }
    }
}
