...
public class GestorAcademia {
    ...
    public static void calcularSueldo() {
        for (Comision s: comisiones) {
            ...
            System.out.println("Profesor: " + s.getProfesor().getNombre() + " //  Sueldo " + s.getProfesor().getSueldo());
            System.out.println();
        }
    }
    ...
    public static void calcularDisciplinaMayorRemuneracion() {
        ...
        System.out.println("La comision mejor remunerada es...\n   Disciplina " + mejorRemunerada.getDisciplina().getNombre() + " " + mejorRemunerada.getNombre());
    }
