...
public class InformeVentas {
    ...
    public static void expendedoresPorLitrosExpendidos() {
        ...
        expendedores.sort(Comparator.comparingInt(Expendedor::getCantLitrosExpendidos).reversed());
    ...
    public static void clienteSegunMontoTotal() {
        ...
        clientes.sort(Comparator.comparingDouble(Cliente::getMontoTotalCompra).reversed());
    ...
    public static ArrayList<Expendedor> getExpendedores() {
        return expendedores;
    }

    public static ArrayList<Playero> getPlayeros() {
        return playeros;
    }
}